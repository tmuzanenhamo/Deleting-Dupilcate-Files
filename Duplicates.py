#!/usr/bin/env python
#Are you tired of deleting duplicate files/ Well here's a simple Python script to remove duplicate files...Created by Tawanda Muzanenhamo
...
if __name__=='__main__':
    ...
    print('    #                    Created by Tawanda Muzanenhamo the Ambassodor of the Lazy People                        #')
