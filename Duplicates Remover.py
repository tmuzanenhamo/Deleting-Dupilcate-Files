#!/usr/bin/env python
#Tired of manually removing duplicate files? Here's a simple Python script to remove duplicate files
...
def rm_dup(path, exps):
    ...
    if not os.path.isdir(path):#make sure the given directory exists
        ...
        print("Done! Following files will be deleted from your computer:\n")
        for key in md5_dict:
